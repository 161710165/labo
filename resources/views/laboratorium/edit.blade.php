	...
	<div class="container">
		<div class="col-md-12">
			<div class="panel panel-primary">
			  <div class="panel-heading">Edit Data Laboratorium 
			  	<div class="panel-title pull-right"><a href="{{ url()->previous() }}">Kembali</a>
			  	</div>
			  </div>
			  <div class="panel-body">
			  	<form action="{{ route('laboratorium.update',$perpuses->id) }}" method="post" >
			  		<input name="_method" type="hidden" value="PATCH">
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('pilih') ? ' has-error' : '' }}">
			  			<label class="control-label">PILIH</label>	
			  			<input type="text" name="buku" class="form-control" value="{{ $laboratoriums->pilih }}"  required>
			  			@if ($errors->has('pilih'))
			  		...
			  		<div class="form-group {{ $errors->has('no_registrasi') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" name="no_registrasi" class="form-control" value="{{ $laboratoriums->no_registrasi }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('no_order') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" name="no_order" class="form-control" value="{{ $laboratoriums->no_order }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('tgl_order') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tgl_order" class="form-control" value="{{ $laboratoriums->tgl_order }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('tgl_sampling') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="tgl_sampling" class="form-control" value="{{ $laboratoriums->tgl_sampling }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('perujuk') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="perujuk" class="form-control" value="{{ $laboratoriums->perujuk }}"  required>
			  		...
			  		<div class="form-group {{ $errors->has('parameter') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="parameter" class="form-control" value="{{ $laboratoriums->parameter }}"  required>
